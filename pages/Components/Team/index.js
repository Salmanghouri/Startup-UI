  ...
  <div className="container">
    ...
    <div className="flex flex-wrap justify-center -mx-4">
      <div className="w-full md:w-1/2 xl:w-1/4 px-4">
        <div className="max-w-[370px] w-full mx-auto mb-10">
          <div className="relative rounded-lg overflow-hidden">
            <img src="https://cdn.tailgrids.com/1.0/assets/images/team/team-01/image-01.jpg" alt="image" className="w-full" />
      ...
      <div className="w-full md:w-1/2 xl:w-1/4 px-4">
        <div className="max-w-[370px] w-full mx-auto mb-10">
          <div className="relative rounded-lg overflow-hidden">
            <img src="https://cdn.tailgrids.com/1.0/assets/images/team/team-01/image-02.jpg" alt="image" className="w-full" />
            <div className="absolute w-full bottom-5 left-0 text-center">
              <div className="
                  bg-white
                  relative
      ...
      <div className="w-full md:w-1/2 xl:w-1/4 px-4">
        <div className="max-w-[370px] w-full mx-auto mb-10">
          <div className="relative rounded-lg overflow-hidden">
            <img src="https://cdn.tailgrids.com/1.0/assets/images/team/team-01/image-03.jpg" alt="image" className="w-full" />
            <div className="absolute w-full bottom-5 left-0 text-center">
              <div className="
                  bg-white
                  relative
      ...
      <div className="w-full md:w-1/2 xl:w-1/4 px-4">
        <div className="max-w-[370px] w-full mx-auto mb-10">
          <div className="relative rounded-lg overflow-hidden">
            <img src="https://cdn.tailgrids.com/1.0/assets/images/team/team-01/image-04.jpg" alt="image" className="w-full" />
            <div className="absolute w-full bottom-5 left-0 text-center">
              <div className="
                  bg-white
                  relative
