...
<footer className="bg-white pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10 p-5 md:p-20">
      ...
      <div className="w-full sm:w-2/3 lg:w-3/12 px-4">
        <div className="w-full mb-10">
          <a href="javascript:void(0)" className="inline-block max-w-[160px] mb-6">
            <img src="https://cdn.tailgrids.com/1.0/assets/images/logo/logo.svg" alt="logo" className="max-w-full" />
          </a>
